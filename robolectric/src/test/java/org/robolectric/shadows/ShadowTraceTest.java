...
public class ShadowTraceTest {
  ...
  @Test
  public void endSection_calledBeforeBeginningAndCrash_throwsIllegalStateException()
      throws Exception {
    ShadowTrace.setCrashOnIncorrectUsage(true);
    try {
      Trace.endSection();
      fail("Must throw");
  ...
  @Test
  public void endSection_oneSectionButCalledTwiceAndCrash_throwsIllegalStateException()
      throws Exception {
    ShadowTrace.setCrashOnIncorrectUsage(true);
    Trace.beginSection("section1");
  ...
  @Test
  public void endSection_calledBeforeBeginning_doesNotThrowByDefault() throws Exception {
    Trace.endSection();
    // Should not crash.
  }

  @Test
  public void endSection_oneSectionButCalledTwice_doesNotThrowByDefault() throws Exception {
    Trace.beginSection("section1");
